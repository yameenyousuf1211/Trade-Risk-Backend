...
const registerValidator = joi.object({
    ...
    businessData: joi.object({
        ...
        constitution: joi.string().valid('partnership', 'Limited Liability Company', 'Public Limited Company', 'Partnership','Estalishment').when('type', { is: 'corporate', then: joi.required(), otherwise: joi.forbidden() }),
